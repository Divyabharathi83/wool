      ...
      <div className="contact-body">
        <div className="contact-info">
          ...
          <div>
            ...
            <span>Address</span>
            <span className="text">2939 Patrick Street, Coimbatore</span>
          </div>
          <div>
            <span><svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" color="black" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 15 15"></polyline></svg></span>
